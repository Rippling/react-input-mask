...
var InputMask = React.forwardRef(function InputMask(props, forwardedRef) {
  var alwaysShowMask = props.alwaysShowMask,
      ...
      shouldSkipInitialFormatting = props.shouldSkipInitialFormatting,
      restProps = _objectWithoutPropertiesLoose(props, ["alwaysShowMask", "children", "mask", "maskPlaceholder", "beforeMaskedStateChange", "shouldSkipInitialFormatting"]);
  ...
  if (isMasked && isControlled) {
    ...
    var newValue = !shouldSkipInitialFormatting && (isFocused || alwaysShowMask || props.value) ? maskUtils.formatValue(props.value) : props.value;
  ...
  var valueProp = isMasked && isControlled ? {
    value: lastValue
  } : undefined;
